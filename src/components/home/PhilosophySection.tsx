...
export default function PhilosophySection() {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
            ...
            >
              ...
              <h2 className="text-[28px] lg:text-5xl font-black tracking-tight text-[var(--foreground)] leading-[1.1] mb-5 lg:mb-6">
                We&apos;re Not Here To Sell You Marketing Plans.
              </h2>
              <p className="text-base lg:text-xl text-[var(--muted)] font-medium mb-6 lg:mb-8 leading-relaxed">
                We&apos;re here to help you find{" "}
                <span className="text-[var(--foreground)] font-black">the right solution.</span>
              </p>
              <p className="text-sm lg:text-base text-[var(--muted)] leading-relaxed mb-8 lg:mb-10 max-w-md">
            ...
            <div className="space-y-4 lg:space-y-5">
              {principles.map((p, i) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="flex gap-4 lg:gap-5 p-5 lg:p-6 rounded-2xl border border-[var(--border)] bg-white shadow-sm lg:shadow-none hover:border-[var(--accent)]/30 hover:bg-[var(--accent-light)]/30 transition-all group"
                >
      ...
      {/* Testimonials */}
      <section className="py-16 lg:py-20 bg-[var(--surface)] overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 sm:px-10">
          <div className="text-left md:text-center mb-8 md:mb-12">
            <span className="text-[10px] font-black text-[var(--accent)] tracking-[0.2em] uppercase block mb-3">What Clients Say</span>
            <h2 className="text-[28px] md:text-3xl leading-[1.1] font-black text-[var(--foreground)]">The Conversation That Changed Things</h2>
          </div>

          {/* Mobile: one full card at a time, native swipe, no autoplay. */}
          <div className="-mx-6 flex snap-x snap-mandatory gap-6 overflow-x-auto overscroll-x-contain px-6 pb-3 scrollbar-hide mobile-momentum-scroll md:hidden">
            {testimonials.map((t) => (
              <article
                key={`mobile-${t.name}`}
                className="w-[calc(100vw-48px)] min-h-[270px] flex-shrink-0 snap-center rounded-2xl border border-[var(--border)] bg-white p-6 shadow-sm"
              >
      ...
      {/* Final CTA banner */}
      <section className="py-16 lg:py-20 bg-[var(--foreground)]">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-[30px] lg:text-5xl font-black text-white tracking-tight leading-[1.1] mb-5">
              Ready for Clarity Over Confusion?
            </h2>
            <p className="text-white/60 text-base lg:text-lg mb-8 lg:mb-10 max-w-xl mx-auto leading-relaxed">
